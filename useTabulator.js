...
scriptLibrary.setAttribute('src', 'https://unpkg.com/tabulator-tables/dist/js/tabulator.min.js')
document.head.appendChild(scriptLibrary)

let linkLibrary = document.createElement('link')
linkLibrary.setAttribute('rel', 'stylesheet')
linkLibrary.setAttribute('href', 'https://unpkg.com/tabulator-tables/dist/css/tabulator.min.css')
